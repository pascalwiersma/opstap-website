...
const OMSCHRIJVING = "OpStap koppelt je aan nieuwe mensen die ook vanavond de stad in willen. Check in, wij maken een groep op basis van jouw interesses. Elke donderdag om 20:00, in Groningen.";
