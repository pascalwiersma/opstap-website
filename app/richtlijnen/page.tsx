        ...
        },
        {
          ...
          inhoud: (
            <>
              ...
              <p className="mt-2">Bezwaar maken via <a href="mailto:opstap@pascal.services" className="text-opstap-orange hover:underline">opstap@pascal.services</a>. Wij reageren binnen 5 werkdagen.</p>
            </>
          ),
        },
        {
