    ...
    <section id="contact" className="py-16 sm:py-20">
      <div className="max-w-6xl mx-auto px-6">
        <div className="rounded-3xl bg-[#141414] border border-white/5 p-8 sm:p-12 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          ...
          <a
            href="/contact"
            className="group flex items-center gap-3 bg-[#1E1E1E] hover:bg-opstap-orange border border-white/8 hover:border-opstap-orange text-white font-semibold px-6 py-4 rounded-2xl transition-all duration-200 shrink-0"
          >
            <svg className="w-4 h-4 text-opstap-orange group-hover:text-white transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
